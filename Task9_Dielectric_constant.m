%% Task 9(Try different value of Dielectric constant of substrate material (1,5 and 10))
n case Dielectric constant = 1:
...
%% Substrate Material
p1.Substrate = dielectric('Name', 'material1', 'EpsilonR', 1); % change 1 to 5, 10 based on task requirement
pb1 = pcbStack(p1);
%% Feed Details
